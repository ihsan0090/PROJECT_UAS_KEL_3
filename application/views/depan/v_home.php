                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                            ...
                            <h4>Guru merupakan faktor penting dalam proses belajar-mengajar.<br> Itulah kenapa kami memilih guru-guru <br>yang mengerti terhadap perkembangan kini.</h4>
                            <div class="slider-btn">
...
<section class="clearfix about about-style2">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
               <h2>Welcome</h2>
               <p>Kami Menyambut baik terbitnya Website SMK METRO yang baru , dengan harapan dipublikasinya website ini sekolah berharap : Peningkatan layanan pendidikan kepada siswa, orangtua, dan masyarakat pada umumnya semakin meningkat. </p>

            </div>
            <div class="col-md-4">
                <img src="<?php echo base_url().'assets/images/sss.png'?>" class="img-fluid about-img" alt="#">
            </div>
        </div>
    </div>
</section>
